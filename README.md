...
3. Для возможности взаимодействия клиента с приложением предусмотрен ряд команд:
nickname - (ввод никнейма) >>> установить никнейм;
public >>> вход в публичный чат;
private - (сообщение) to (ввод никнейма пользователя из публичного чата)  - приватное сообщение;
timer ... '%Y, %m, %d, %H, %M, %S' - сообщение отправляется в чат через определенное время;
report to (ввод никнейма пользователя) - жалоба на другого пользователя
